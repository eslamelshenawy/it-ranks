...
import static com.itranks.dbservice.constatnts.TestCommons.getHttpEntity;
...
public class LookupControllerTest {
    ...
    public void SetSessionTest() throws Exception {
        HttpEntity<?> request = TestCommons.getHttpEntity("null", "ARABIC");
